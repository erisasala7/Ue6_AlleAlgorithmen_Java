...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int biggersize = (int)cacheSize +2;
        ...
        System.out.println(ANSI_BLUE +"Quick Sort: Best case run with array of size with arraysize=  " + arraysize+ ANSI_RESET);
        ...
        //Quick_Sorting.clearCache(cacheSize);
        System.out.println(ANSI_BLUE +"Quick Sort: Worst case run with array of arraysize= " + arraysize+ANSI_RESET);
        Selection_Sorting.fillUpArrayRng(array_innerhalb_cache);
        timerstart = ZonedDateTime.now().toInstant().toEpochMilli();
      ...
      //  Quick_Sorting.clearCache(cacheSize);
        ...
        System.out.println(ANSI_BLUE +"Quick Sort: Best case run with array of arraysize=cachesize " + cacheSize+ANSI_RESET);
        ...
        System.out.println(ANSI_BLUE +"Quick Sort: Worst case run with array of arraysize=cachesize " + cacheSize+ANSI_RESET);
        Selection_Sorting.fillUpArrayRng(array_ausserhalb_cache);
        timerstart = ZonedDateTime.now().toInstant().toEpochMilli();
        ...
        System.out.println("Count Sort: Randomly filled array with size:  " + arraysize);
        Quick_Sorting.clearCache(cacheSize);
        ...
        Quick_Sorting.printArray(array_innerhalb_cache, arraysize);
        System.out.println("Elapsed Time in milliseconds: "+ (timerend-timerstart));
        System.out.println(" ");

        //selection sort - regular array size - best case run
        System.out.println("Count Sort: Best case run with array of size: " + arraysize);
        Quick_Sorting.clearCache(cacheSize);
